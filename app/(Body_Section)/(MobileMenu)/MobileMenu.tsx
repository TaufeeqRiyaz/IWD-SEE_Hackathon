  ...
  return (
    ...
    >
      ...
      >
        ...
        <a href="https://github.com/TaufeeqRiyaz/Introduction-To-Git-And-GitHub" target="_blank">
        <div className="w-full h-auto hover:bg-[#221d41] rounded-[8px] flex flex-row py-[13px] px-[5px] 600:px-[15px] ">
          <div className=" flex flex-col">
            ...
            Beginner level course to introduce Git and GitHub
            </p>
          </div>
        </div>
        </a>
      ...
      <Link
        href={"hptts://github.com/TaufeeqRiyaz?tab=repositories"}
        className=" w-full min-h-[50px] rounded-[10px] border
      ...
      <Link
        href={"https://chat.whatsapp.com/GXqIV8O8IbDDB5Q2EMziVA"}
